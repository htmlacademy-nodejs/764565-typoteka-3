...
describe(`API returns category list`, () => {
  ...
  test(`Category names are "Без рамки", "Рисование", "Музыка", "Экономия", "Программирование", "Хобби", "Радио"`,
      () => expect(response.body).toEqual(
          expect.arrayContaining([`Без рамки\r`, `Рисование\r`, `Музыка\r`, `Экономия\r`, `Программирование\r`, `Хобби\r`, `Радио\r`])
      )
  );
});
